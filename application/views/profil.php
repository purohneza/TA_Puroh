<html>
  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li><a href="http://localhost/codeigniter/index.php/welcome">Home</a></li>
            <li  class="active"><a href="http://localhost/codeigniter/index.php/welcome/profil">Profil</a></li>
            </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
    ...
    <section id="content">
    <h1>Profil Pembuat Website</h1><br>
      <table width=550>
        <tr>
          <td>Nama</td>
          <td>:</td> 
          <td>Neneng sapuroh</td>
        </tr>
    ...
    <h3>&copy;Neneng Sapuroh</h3></footer>
